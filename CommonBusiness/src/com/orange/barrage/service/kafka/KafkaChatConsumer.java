...
public class KafkaChatConsumer {
    ...
    private static final String KAFKA_GROUP = PropertyUtil.getStringProperty("kafka.group", "chat-agent-group-1");
    ...
    public KafkaChatConsumer(String agentId, int groupIndex, KafkaChatConsumerCallbackInterface callback) {
        ...
        //group 代表一个消费组
        props.put("group.id", String.format("%s-%d", KAFKA_GROUP, groupIndex));
    ...
    public void start() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                KafkaChatDecoder valueDecoder = new KafkaChatDecoder();
