...
public final class GameConstantsProtos {
  ...
  public enum PBMessageType
    ...
    public static PBMessageType valueOf(int value) {
      switch (value) {
        case 0: return Text;
        case 1: return LocationRequest;
        case 2: return LocationResponse;
        case 4: return Draw;
        case 5: return Image;
        case 6: return Voice;
        default: return null;
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.orange.network.game.protocol.constants.GameConstantsProtos.getDescriptor().getEnumTypes().get(7);
    }
    
    private static final PBMessageType[] VALUES = {
      Text, LocationRequest, LocationResponse, Draw, Image, Voice, 
    };
    ...
    // @@protoc_insertion_point(enum_scope:game.PBMessageType)
  }
  ...
  public enum PBContestStatus
    ...
    public static PBContestStatus valueOf(int value) {
      switch (value) {
    ...
    public static com.google.protobuf.Internal.EnumLiteMap<PBContestStatus>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static com.google.protobuf.Internal.EnumLiteMap<PBContestStatus>
        internalValueMap =
          new com.google.protobuf.Internal.EnumLiteMap<PBContestStatus>() {
            public PBContestStatus findValueByNumber(int number) {
              return PBContestStatus.valueOf(number);
            }
          };
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.orange.network.game.protocol.constants.GameConstantsProtos.getDescriptor().getEnumTypes().get(8);
    }
    
    private static final PBContestStatus[] VALUES = {
      Pending, Running, Passed, Deleted, 
    };
    
    public static PBContestStatus valueOf(
        com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
      if (desc.getType() != getDescriptor()) {
        throw new java.lang.IllegalArgumentException(
          "EnumValueDescriptor is not for this type.");
    ...
    private PBContestStatus(int index, int value) {
      this.index = index;
      this.value = value;
    }
    
    // @@protoc_insertion_point(enum_scope:game.PBContestStatus)
  }
  ...
  public enum PBOpusCategoryType
    ...
    public static PBOpusCategoryType valueOf(int value) {
      switch (value) {
        case 0: return DRAW_CATEGORY;
        case 1: return SING_CATEGORY;
        case 2: return ASK_PS_CATEGORY;
        default: return null;
      }
    }
    
    public static com.google.protobuf.Internal.EnumLiteMap<PBOpusCategoryType>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static com.google.protobuf.Internal.EnumLiteMap<PBOpusCategoryType>
        internalValueMap =
          new com.google.protobuf.Internal.EnumLiteMap<PBOpusCategoryType>() {
            public PBOpusCategoryType findValueByNumber(int number) {
              return PBOpusCategoryType.valueOf(number);
            }
          };
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.orange.network.game.protocol.constants.GameConstantsProtos.getDescriptor().getEnumTypes().get(9);
    }
    
    private static final PBOpusCategoryType[] VALUES = {
      DRAW_CATEGORY, SING_CATEGORY, ASK_PS_CATEGORY, 
    };
    
    public static PBOpusCategoryType valueOf(
        com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
      if (desc.getType() != getDescriptor()) {
        throw new java.lang.IllegalArgumentException(
          "EnumValueDescriptor is not for this type.");
    ...
    private PBOpusCategoryType(int index, int value) {
      this.index = index;
      this.value = value;
    }
    
    // @@protoc_insertion_point(enum_scope:game.PBOpusCategoryType)
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\006Opuses\020\001*d\n\rPBMessageType\022\010\n\004Text\020\000\022\023\n" +
      "\017LocationRequest\020\001\022\024\n\020LocationResponse\020\002" +
      "\022\010\n\004Draw\020\004\022\t\n\005Image\020\005\022\t\n\005Voice\020\006*D\n\017PBCo",
      "ntestStatus\022\013\n\007Pending\020\001\022\013\n\007Running\020\002\022\n\n" +
      "\006Passed\020\003\022\013\n\007Deleted\020\004*O\n\022PBOpusCategory" +
      "Type\022\021\n\rDRAW_CATEGORY\020\000\022\021\n\rSING_CATEGORY" +
      "\020\001\022\023\n\017ASK_PS_CATEGORY\020\002BA\n*com.orange.ne" +
      "twork.game.protocol.constantsB\023GameConst" +
      "antsProtos"
    };
