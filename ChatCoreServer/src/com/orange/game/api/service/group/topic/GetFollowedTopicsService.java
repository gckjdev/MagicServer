 ...
 */
public class GetFollowedTopicsService extends CommonGameService {
    ...
    public void handleData() {
        ...
        List<BBSPost> posts = UserTopicIndexManager.getManagerForFollow().getList(userId, offset, limit);
