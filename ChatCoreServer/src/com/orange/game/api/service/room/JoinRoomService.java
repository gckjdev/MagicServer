...
public class JoinRoomService extends CommonGameService {
	...
	public void handleData() {
		...
		if (!flag) {
			...
			RoomManager.updateRoomUser(mongoClient, roomId, userId, gender, userNickName, userAvatar, RoomUser.STATUS_PLAYING, new Date(), true);
		}
	}
