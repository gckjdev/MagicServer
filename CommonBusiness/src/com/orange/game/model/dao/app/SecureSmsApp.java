...
public class SecureSmsApp extends AbstractApp {

	public SecureSmsApp(String appidCalltrack, String gameIdCalltrack) {
	...
	public ApnsService apnsService() {
		return NotificationService.secureSmsPushApsnServiceHolder.get();
	}
