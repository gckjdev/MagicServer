 ...
 */
public class RemoveUserFromAdminService extends CommonGameService {
    ...
    public void handleData() {
        resultCode = GroupRoleManager.removeUserFromAdmin(mongoClient, userId, groupId, targetUid);
        byteData = protocolBufferWithErrorCode(resultCode);
    }

    @Override
    public String toString() {
        return "RemoveUserFromAdminService{" +
                "groupId='" + groupId + '\'' +
                ", targetUid='" + targetUid + '\'' +
                '}';
    }
