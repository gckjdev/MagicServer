...
public class BuyLearnDrawService extends CommonGameService {
	...
	public void handleData() {
		LearnDrawManager.buyDraw(mongoClient, drawId, userId, sellContentType);
	}
	...
	public String toString() {
		return "BuyLearnDrawService [userId=" + userId + ", appId=" + appId
